        ...
        <div className="space-y-8">
            <div className="flex justify-between items-center border-b border-hw-border pb-5">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">
                        الملف الشخصي: <span className="text-hw-accent">{targetUser.username}</span>
                    </h2>
                    <p className="text-hw-text-secondary mt-1 font-bold">عرض حالة الحساب والتحويلات الخاصة به</p>
                </div>
                <Link href="/dashboard/users" className="px-4 py-2 border border-hw-border rounded-lg text-sm font-semibold text-hw-text hover:bg-hw-surface transition">
                    العودة للحسابات
                </Link>
            </div>
            ...
            <div>
                ...
                {userBalancesMap.size === 0 ? (
                    <p className="text-sm text-hw-text-muted font-bold">لا يوجد رصيد حالياً</p>
                ) : (
